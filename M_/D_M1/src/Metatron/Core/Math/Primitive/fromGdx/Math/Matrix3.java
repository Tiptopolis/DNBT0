...
public class Matrix3 implements Serializable {
	...
	public Matrix3 setToRotation (float degrees) {
		return setToRotationRad(aMaths.degreesToRadians * degrees);
	}
	...
	public Matrix3 setToRotation (Vector3 axis, float degrees) {
		return setToRotation(axis, aMaths.cosDeg(degrees), aMaths.sinDeg(degrees));
	}
	...
	public Matrix3 rotate (float degrees) {
		return rotateRad(aMaths.degreesToRadians * degrees);
	}
	...
	public float getRotation () {
		return aMaths.radiansToDegrees * (float)Math.atan2(val[M10], val[M00]);
	}
