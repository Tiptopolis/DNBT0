...
public abstract class Camera {
	...
	public Vector3 unproject (Vector3 screenCoords, float viewportX, float viewportY, float viewportWidth, float viewportHeight) {
		float x = screenCoords.x - viewportX, y = M_Gfx.getHeight() - screenCoords.y - viewportY;
	...
	public Vector3 unproject (Vector3 screenCoords) {
		unproject(screenCoords, 0, 0, M_Gfx.getWidth(), M_Gfx.getHeight());
		return screenCoords;
	}
	...
	public Vector3 project (Vector3 worldCoords) {
		project(worldCoords, 0, 0, M_Gfx.getWidth(), M_Gfx.getHeight());
		return worldCoords;
	}
	...
	public Ray getPickRay (float screenX, float screenY) {
		return getPickRay(screenX, screenY, 0, 0, M_Gfx.getWidth(), M_Gfx.getHeight());
	}
}